...
<div class="container margin_60">
    <div class="main_title">
        ...
        <div class="menu-plan-nav text-center">
            <a class="btn btn-grey" href="{{ route("plan_two") }}">Thực đơn cho 2 người</a>
            <a class="btn btn-active" href="{{ route("plan_family") }}">Thực đơn cho 7 người</a>
        </div>
        <hr class="divider">
    </div><!-- End main_title -->
    <div class="row">
